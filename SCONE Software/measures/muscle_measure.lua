...
function update( model )
    ...
    muscle_effort = ( muscle_effort + (math.abs(force_hamstrings_r) - math.abs(force_hamstrings_l))*hams_weight + (math.abs(force_glut_max_r) - math.abs(force_glut_max_l))*glut_weight + (math.abs(force_iliopsoas_r) - math.abs(force_iliopsoas_l))*ilio_weight ) 
