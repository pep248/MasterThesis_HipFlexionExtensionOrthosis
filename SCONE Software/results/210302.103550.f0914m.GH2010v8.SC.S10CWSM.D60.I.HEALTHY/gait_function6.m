...
plot(time_1,fake_sine_y,'LineWidth',2) % original position
plot(time_2,fake_sine_y2,'LineWidth',2) % original position
plot(time_3,fake_sine_y3,'LineWidth',2) % original position
plot(time_4,fake_sine_y4,'LineWidth',2) % original position
%legend('Healthy Gait Moment','Sinusoidal Fit')
