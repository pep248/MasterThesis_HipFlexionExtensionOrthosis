...
%% READ EXCEL FILE
table = xlsread('Winter_Gait.xls','Joint Rotations');

%% PLOT
gait = table(307:357, 1);

very_slow_minus = table(307:357, 2);
very_slow = table(307:357, 3);
very_slow_plus = table(307:357, 4);

slow_minus = table(307:357, 5);
slow = table(307:357, 6);
slow_plus = table(307:357, 7);

free_minus = table(307:357, 8);
free = table(307:357, 9);
free_plus = table(307:357, 10);

fast_minus = table(307:357, 11);
fast = table(307:357, 12);
fast_plus = table(307:357, 13);

very_fast_minus = table(307:357, 14);
very_fast = table(307:357, 15);
very_fast_plus = table(307:357, 16);
