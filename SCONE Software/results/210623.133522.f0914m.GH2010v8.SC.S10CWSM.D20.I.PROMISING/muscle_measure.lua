...
function update( model )
    ...
    muscle_effort = ( math.abs(force_hamstrings_r) + math.abs(force_glut_max_r) + math.abs(force_iliopsoas_r) ) / steps
...
function store_data( frame )
	...
	frame:set_value("effort", muscle_effort );
